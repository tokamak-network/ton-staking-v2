...
import {Layer2ManagerStorage} from "./Layer2ManagerStorage.sol";
import {Layer2ManagerV1_2Storage} from "./Layer2ManagerV1_2Storage.sol";
...
contract Layer2ManagerV3 is ProxyStorage, AccessibleCommon, Layer2ManagerStorage, Layer2ManagerV1_2Storage {
    ...
    function setAddresses1(
        ...
        emit SetAddresses1(_l1BridgeRegistry, _operatorManagerFactory, _ton, _wton);
    }

    /// @notice 주소 설정 (2단계: 나머지 매니저)
    function setAddresses2(
        address _dao,
        address _depositManager,
        address _seigManager,
        address _swapProxy
    )  external  onlyOwner {
        require(ton != address(0), "setAddresses1 not called");
        ...
        emit SetAddresses2(_dao, _depositManager, _seigManager, _swapProxy);
    }
