...
import "./MockFaultDisputeGame.sol";
...
import { GameType, Claim, Hash, Timestamp, GameId, LibGameId, Duration } from "../layer2/lib/LibUDT.sol";
...
contract MockDisputeGameFactory is IDisputeGameFactory {
        ...
        returns (IDisputeGame proxy_)
    {
        ...
        MockFaultDisputeGame game = new MockFaultDisputeGame(params, _rootClaim, _extraData);
    ...
    function getGameUUID(
        ...
        returns (Hash uuid_)
    {
        uuid_ = Hash.wrap(keccak256(abi.encodePacked(GameType.unwrap(_gameType), Claim.unwrap(_rootClaim), _extraData)));
    }
