...
func (_DisputeGameFactory *DisputeGameFactoryCaller) GameAtIndex(opts *bind.CallOpts, _index *big.Int) (struct {
	...
	outstruct.GameType = out[0].(uint32)
	outstruct.Timestamp = out[1].(uint64)
	outstruct.Proxy = out[2].(common.Address)
...
func (_DisputeGameFactory *DisputeGameFactoryCaller) Games(opts *bind.CallOpts, _gameType uint32, _rootClaim [32]byte, _extraData []byte) (struct {
	...
	outstruct.Proxy = out[0].(common.Address)
	outstruct.Timestamp = out[1].(uint64)
...
func (_DisputeGameFactory *DisputeGameFactoryCaller) SystemConfig(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _DisputeGameFactory.contract.Call(opts, &out, "systemConfig")
...
//
// Solidity: function systemConfig() view returns(address)
func (_DisputeGameFactory *DisputeGameFactorySession) SystemConfig() (common.Address, error) {
	return _DisputeGameFactory.Contract.SystemConfig(&_DisputeGameFactory.CallOpts)
}

// SystemConfig is a free data retrieval call binding the contract method 0x33d7e2bd.
//
// Solidity: function systemConfig() view returns(address)
func (_DisputeGameFactory *DisputeGameFactoryCallerSession) SystemConfig() (common.Address, error) {
	return _DisputeGameFactory.Contract.SystemConfig(&_DisputeGameFactory.CallOpts)
}
...
// SetSystemConfig is a paid mutator transaction binding the contract method 0xd58a0103.
//
// Solidity: function setSystemConfig(address _systemConfig) returns()
func (_DisputeGameFactory *DisputeGameFactoryTransactor) SetSystemConfig(opts *bind.TransactOpts, _systemConfig common.Address) (*types.Transaction, error) {
	return _DisputeGameFactory.contract.Transact(opts, "setSystemConfig", _systemConfig)
}

// SetSystemConfig is a paid mutator transaction binding the contract method 0xd58a0103.
//
// Solidity: function setSystemConfig(address _systemConfig) returns()
func (_DisputeGameFactory *DisputeGameFactorySession) SetSystemConfig(_systemConfig common.Address) (*types.Transaction, error) {
	return _DisputeGameFactory.Contract.SetSystemConfig(&_DisputeGameFactory.TransactOpts, _systemConfig)
}

// SetSystemConfig is a paid mutator transaction binding the contract method 0xd58a0103.
//
// Solidity: function setSystemConfig(address _systemConfig) returns()
func (_DisputeGameFactory *DisputeGameFactoryTransactorSession) SetSystemConfig(_systemConfig common.Address) (*types.Transaction, error) {
	return _DisputeGameFactory.Contract.SetSystemConfig(&_DisputeGameFactory.TransactOpts, _systemConfig)
}
