...
import { AutoRefactorCoinageI } from "../stake/interfaces/AutoRefactorCoinageI.sol";
import { DSMath } from "../libraries/DSMath.sol";
import "../libraries/SArrays.sol";

import "../proxy/ProxyStorage.sol";
import { AuthControlCoinage } from "../common/AuthControlCoinage.sol";
import { L2RefactorCoinageSnapshotStorage } from "./L2RefactorCoinageSnapshotStorage.sol";
...
contract L2RefactorCoinageSnapshot is ProxyStorage, AuthControlCoinage, L2RefactorCoinageSnapshotStorage, DSMath {
     ...
     *  onlyMinter
     **/
    function updateFactor(IRefactor.Factor memory _factor) external onlyMinter {
      _updateFactor(_factor);
    }
    ...
    function updateBalance(
      ...
      bool totalBool
        ...
        _update( _accountBalance,  _totalBalance, account, accountBool, totalBool);
    }
