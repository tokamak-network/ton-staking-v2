...
contract OperatorManagerV1_1 is Ownable, OperatorManagerStorage {
     ...
     * @param amount    the deposit wton amount (ray)
     * @param flgaTon   If it is true, claim with ton, otherwise claim with wton
     */
    function claimByCandidateAddOn(uint256 amount, bool flgaTon) public onlyCandidateAddOn {
