 ...
 *
 */
contract newSeigManager2 is ProxyStorage, AuthControlSeigManager, SeigManagerStorage, SeigManagerI, DSMath {
  ...
  function setNewDepositManager(address new_) external onlyOwner {
    newDepositManager = new_;
  }
    ...
    returns (bool)
  {
    ...
    // emit UnstakeLog(amount, totAmount);
    require(newDepositManager == account, "SeigManager: need only newDepositContract");
