...
/// @title MockDAOCommitteeProxyForWithdrawal
contract MockDAOCommitteeProxyForWithdrawal is StorageStateCommittee, AccessControl {
...
interface IDAOCommitteeProxy2ForWithdrawal {
...
contract ValidatorWithdrawalRestrictionTest is Test, DeployV3Full {
    ...
    function _deployDAO() internal {
        MockDAOCommitteeProxyForWithdrawal mockProxy = new MockDAOCommitteeProxyForWithdrawal(ton);
        ...
        IDAOCommitteeProxy2ForWithdrawal(daoCommitteeProxy).upgradeTo2(daoCommitteeV1);
        IDAOCommitteeProxy2ForWithdrawal(daoCommitteeProxy).setAliveImplementation2(daoCommitteeOwner, true);
        ...
        IDAOCommitteeProxy2ForWithdrawal(daoCommitteeProxy).setSelectorImplementations2(ownerSelectors, daoCommitteeOwner);
    ...
    function test_INT013_dynamicMinimum_changesWithValidatorCount() public {
        ...
        uint256 dMinWith1 = rat.getDynamicMinimumCollateral(address(mockSystemConfig));
