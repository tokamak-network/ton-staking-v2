...
/// @title FastWithdrawalE2EForkTest
/// @notice Fast Withdrawal E2E Fork Tests - BLS precompile 필요 테스트만 포함
/// @dev 메인넷 포크로 실행: forge test --match-path "test/v3/scenarios/FastWithdrawalE2EFork.t.sol" --fork-url <mainnet-rpc>
contract FastWithdrawalE2EForkTest is V3TestBase {
    // Test addresses
    ...
    function test_E2E_VerifyAndExecuteFastWithdrawal_WithBLS() public onlyWithBLSPrecompiles {
        ...
        // Set pendingFees (simulates requestFastWithdrawal storing the TON fee)
    ...
    function test_E2E_VerifyAndExecute_MultipleValidators() public onlyWithBLSPrecompiles {
        ...
        vm.prank(aggregator);
        ratFastWithdrawal.verifyAndExecuteFastWithdrawal(testWithdrawal, input, TEST_BLS_SIGNATURE);
