...
import {OnlyDepositManagerError, OnlyL1BridgeOrRegistryError} from "../../src/stake/managers/SeigManagerV1_4.sol";
...
/// @title MockDAOCommitteeProxyForSecurity
contract MockDAOCommitteeProxyForSecurity is StorageStateCommittee, AccessControl {
...
interface IDAOCommitteeProxy2ForSecurity {
...
contract SecurityPermissionsTest is Test, DeployV3Full {
    ...
    function _deployDAO() internal {
        MockDAOCommitteeProxyForSecurity mockProxy = new MockDAOCommitteeProxyForSecurity(ton);
        ...
        IDAOCommitteeProxy2ForSecurity(daoCommitteeProxy).upgradeTo2(daoCommitteeV1);
        IDAOCommitteeProxy2ForSecurity(daoCommitteeProxy).setAliveImplementation2(daoCommitteeOwner, true);
        ...
        IDAOCommitteeProxy2ForSecurity(daoCommitteeProxy).setSelectorImplementations2(ownerSelectors, daoCommitteeOwner);
    ...
    function test_SEC010_ifFree_SeigManager() public {
    ...
    function test_SEC010_ifFree_DepositManager() public {
        // DepositManagerV1_1Storage.sol:14에 ifFree modifier 정의됨
        // DepositManagerV1_2.sol:101에서 withdrawAndDepositL2가 ifFree 사용
