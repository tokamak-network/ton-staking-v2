...
const layers = [
    ...
    {"oldLayer":"0xc811b0eca34f154e10afba0178ca037e4fb159c4",
...
describe('Goerli Simple Staking Test', () => {
    ...
    describe('updateSeigniorage', () => {
        ...
        it('updateSeigniorageAll ', async () => {
            ...
            for(i = 0; i < num ; i++){
                ...
                let layer2 = layers[i].newLayer;

                console.log("updateSeigniorageLayer ", i, layer2)
