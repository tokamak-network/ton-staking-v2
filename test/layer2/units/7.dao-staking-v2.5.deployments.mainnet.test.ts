...
describe('Layer2Manager', () => {
    ...
    describe('# Agenda', () => {
        ...
        it('Submit an agenda', async () => {
            ...
            const functions = [
                _setCooldownTime,_setLayer2CandidateFactory,_setLayer2Manager,_setSeigManager,_setDaoVault,
                _setLayer2Registry,_setAgendaManager,_setCandidateFactory,_setTon,_setWton,
                _increaseMaxMember,_setQuorum,_decreaseMaxMember,_setActivityRewardPerSecond,
                _setCandidatesSeigManager,_setCandidatesCommittee,_setBurntAmountAtDAO,_setdaoExecuteTransaction
            ]
