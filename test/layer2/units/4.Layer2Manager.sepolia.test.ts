...
describe('Layer2Manager', () => {
    ...
    describe('# DepositManager : CandidateAddOn ', () => {
        ...
        it('seigManager: updateSeigniorageLayer : the first updateSeigniorage to titanLayerAddress : no give seigniorage to l2', async () => {
            ...
            const l2RewardPerUint1 = await seigManager.l2RewardPerUint()
            ...
            // console.log('l2RewardPerUint', l2RewardPerUint1)
            ...
            const l2RewardPerUint2 = await seigManager.l2RewardPerUint()
            console.log('l2RewardPerUint', l2RewardPerUint2)
