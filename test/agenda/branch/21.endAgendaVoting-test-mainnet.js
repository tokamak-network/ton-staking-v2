...
describe("DAO Proxy Change Test", () => {
    ...
    describe("endAgendaVoting test", () => {
        describe("upgraded DAOContract Agenda", () => {
            ...
            it("endAgendaVoting before vote", async () => {
                await expect(
                    daoCommittee_V1_Contract.connect(user1).endAgendaVoting(
                        agendaID
                    )).to.be.reverted;
            })
            ...
            it("endAgendaVoting after vote before votingEndTime", async () => {
                await expect(
                    daoCommittee_V1_Contract.connect(user1).endAgendaVoting(
                        agendaID
                    )).to.be.reverted;
            ...
            it("endAgendaVoting after vote", async () => {
                const agenda1 = await daoagendaManager.agendas(agendaID);
                console.log(agenda1)
                console.log("-----------------------------------")
