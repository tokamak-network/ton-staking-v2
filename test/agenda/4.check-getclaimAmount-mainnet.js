...
describe("DAOAgenda Test", () => {
    ...
    describe("getclaimAmount Test", () => {
        ...
        it("get activityRewardPerSecond", async () => {
            let amount = await daoCommittee.activityRewardPerSecond()
            console.log("amount : ", amount);
        })
    })

    describe("candidateInfos Test", () => {
        it("candidateInfos", async () => {
            let info = await daoCommittee.candidateInfos(member1Addr)
            console.log(info);
        })
    })
})
