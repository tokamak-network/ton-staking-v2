...
describe(' Simple Staking Test', () => {
    ...
    before('create fixture loader', async () => {
        ...
        layer2Info_1 = {
            ...
            layer2: "0xCBeF7Cc221c04AD2E68e623613cc5d33b0fE1599",
        ...
        layer2Info_2 = {
            ...
            committee: deployed.daoCommittee.address,
            layer2:  "0x277201BF0B20C672b023408Bf7778cFf3779b476",
    ...
    describe('basic functions ', () => {
        ...
        it('deposit to layer1 using approveAndCall', async () => {
            ...
            let tonAmount = ethers.utils.parseEther("1001")
        ...
        it('deposit to tokamak using deposit(address,address,uint256) ', async () => {
            // console.log(deployed.seigManagerV2)
            let account = deployer
            let wtonAmount = ethers.utils.parseEther("2001"+"0".repeat(9))
            ...
            let stakedA = await deployed.seigManagerV2["stakeOf(address,address)"](layer2Info_2.layer2, layer2Info_2.operatorAdmin)

            await (await deployed.depositManagerV2.connect(deployer)["deposit(address,address,uint256)"](
                layer2Info_2.layer2,
                layer2Info_2.operatorAdmin,
                wtonAmount
            )).wait()
            ...
            let stakedB = await deployed.seigManagerV2["stakeOf(address,address)"](layer2Info_2.layer2, layer2Info_2.operatorAdmin)
        ...
        it('deposit to layer1 using deposit(address,address,uint256) ', async () => {
            // console.log(deployed.seigManagerV2)
            let account = deployer
            let wtonAmount = ethers.utils.parseEther("2001"+"0".repeat(9))
            // await deployed.WTON.connect(deployer).transfer(addr1.address, wtonAmount);
            ...
            let stakedA = await deployed.seigManagerV2["stakeOf(address,address)"](layer2Info_1.layer2, layer2Info_2.operatorAdmin)

            await (await deployed.depositManagerV2.connect(deployer)["deposit(address,address,uint256)"](
                layer2Info_1.layer2,
                layer2Info_1.operatorAdmin,
                wtonAmount
            )).wait()
    ...
    describe('updateSeigniorage', () => {
        ...
        it('deposit to layer1', async () => {
            ...
            expect(roundDown(stakedB.add(ethers.BigNumber.from("10")),3)).to.be.eq(
                roundDown(stakedA.add(wtonAmount), 3)
            )
