...
describe('SeigManagerV1', () => {
    ...
    before('create fixture loader', async () => {
        deployed = await simpleStakeFixture(false)
    ...
    describe('deposit ', () => {
        ...
        it('Talken:Deposits are possible even if the operator does not stake the minimum collateral.', async () => {
            ...
            // console.log(jsonInfo.Candidate.abi)
        ...
        it('upgrade SeigManagerV1_2', async () => {
            await (await deployed.seigManagerProxy.connect(daoAdmin).upgradeTo(
                deployed.seigManagerV1_2.address
            )).wait()
        });

        it('Talken: If the operator does not stake the minimum collateral, it cannot be deposited.', async () => {
            // console.log(deployed.seigManagerV2)
            ...
            await expect ( deployed.TON.connect(account).approveAndCall(
                deployed.WTON.address,
                tonAmount,
                data,
                {from: account.address}
        ...
        it('Talken: The operator stakes the minimum collateral.', async () => {
        ...
        it('Talken: If the operator stakes the minimum collateral, you can deposit.', async () => {
