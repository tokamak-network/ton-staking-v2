...
async function seigManagerCheck() {
    ...
    for (i = 0; i < layerlevel19.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerlevel19[i].balance))) {
            console.log("=====================[tokamak : ",i,", account : ", layerlevel19[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layertokamak.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layertokamak[i].balance))) {
            console.log("=====================[tokamak : ",i,", account : ", layertokamak[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layerHammerDAO.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerHammerDAO[i].balance))) {
            console.log("=====================[hammerDAO : ",i,", account : ", layerHammerDAO[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layerDXMCorp.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerDXMCorp[i].balance))) {
            console.log("=====================[DXMCorp : ",i,", account : ", layerDXMCorp[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layerdanalFintech.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerdanalFintech[i].balance))) {
            console.log("=====================[danalFintech : ",i,", account : ", layerdanalFintech[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layerDeSpread.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerDeSpread[i].balance))) {
            console.log("=====================[DeSpread : ",i,", account : ", layerDeSpread[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layerdecipher.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerdecipher[i].balance))) {
            console.log("=====================[decipher : ",i,", account : ", layerdecipher[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layerTalken.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerTalken[i].balance))) {
            console.log("=====================[Talken : ",i,", account : ", layerTalken[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layerDSRV.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerDSRV[i].balance))) {
            console.log("=====================[DSRV : ",i,", account : ", layerDSRV[i].account, "] ERROR ====================");
        }
    }
    ...
    for (i = 0; i < layerstaked.length; i++) {
        ...
        if(!balance.eq(ethers.BigNumber.from(layerstaked[i].balance))) {
            console.log("=====================[staked : ",i,", account : ", layerstaked[i].account, "] ERROR ====================");
        }
    }
