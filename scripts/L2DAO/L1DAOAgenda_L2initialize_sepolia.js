...
async function L1toL2Agenda() {
    ...
    // let l1CrossDomainMessenger = "0xd054Bc768aAC07Dd0BaA2856a2fFb68F495E4CC2"
    ...
    const functionBytecode0 = l2crossTradeProxy.interface.encodeFunctionData(
    ...
    const functionBytecode1 = l2daoExecutor.interface.encodeFunctionData(
        "execute", [sepoliaContractInfo.L2CrossTradeProxy, functionBytecode0]
    )
    ...
    const functionBytecodeSimple = l1CrossDomainMessenger.interface.encodeFunctionData(
        "sendMessage", [sepoliaContractInfo.L2DAOExecutor, functionBytecode1, minGasLimit]
    )
    targets.push(sepoliaContractInfo.l1CrossDomainMessenger);
    functionBytecodes.push(functionBytecodeSimple)
