...
| SM-024 | test_SM024_v2_validatorReward_shouldNotDistribute | V2에서 ValidatorReward 분배 없음 |
...
| MIG-003 | test_MIG003_afterMigration_v3Functions_shouldWork | 마이그레이션 후 V3 함수 실제 동작 |
| MIG-004 | test_MIG004_afterMigration_v2Functions_shouldUseV3Logic | 마이그레이션 후 V2 함수도 V3 로직 사용 |
| MIG-005 | test_MIG005_afterMigration_onStakingChange_shouldWork | 마이그레이션 후 onStakingChange 정상 동작 |
...
### DepositManagerV1_2Real.t.sol (17개)
...
| DM-007 | test_DM007_accStaked_initialZero | 초기 누적 스테이킹 = 0 |
| DM-008 | test_DM008_pendingUnstaked_initialZero | 초기 대기 출금 = 0 |
| DM-009 | test_DM009_numPendingRequests_initialZero | 초기 대기 요청 수 = 0 |
